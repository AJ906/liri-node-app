...
###Getting Started
* [Demo] (https://youtu.be/lko8E2jy_-A)
################################

##Prerequisites

You'll need import/access the following recreate Liri:
...
#Files needed:
.env  - to store keys
.gitignore - to make keys private
keys.js - to access keys from .env file
liri.js (main code) - to fun access keys to run functional code
package-lock.json - to store imported NPM info needed to run Liri
package.json - to store requirements and version data
random.txt - text file used to drive "do-what-it-says" function
README.md - file to give insight on how the sausage is made. ;-)
